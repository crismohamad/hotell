...
s
 ...
 <!-- RoomDetails -->
            <div id="RoomDetails" class="carousel slide" data-ride="carousel">
                ...
                <div class="item active"><img src="photos/double.jpg" class="img-responsive" alt="slide"></div>
                <div class="item  height-full"><img src="photos/9.jpg"  class="img-responsive" alt="slide"></div>
                <div class="item active"><img src="photos/wing.jpg" class="img-responsive" alt="slide"></div>
...
<div class="room-features spacer">
  <div class="row">
    ...
    <div class="col-sm-3 col-md-2">
      <div class="size-price">Price<span>$8000.00</span></div>
    </div>
  </div>
</div>
